  ...
  config = {
    ...
    stylix = {
      ...
      base16Scheme = {
        ...
        base04 = "dde1e6"; # Dark Foreground (Used for status bars)
        ...
        base0C = "be95ff"; # Support, Regular Expressions, Escape Characters, Markup Quotes
        base0D = "82cfff"; # Functions, Methods, Attribute IDs, Headings, Accent color
